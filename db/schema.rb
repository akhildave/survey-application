...
ActiveRecord::Schema.define(version: 20150302125141) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "about_studies", force: true do |t|
    t.text     "description1"
    t.text     "description2"
    t.text     "description3"
    t.string   "heading"
  ...
  create_table "about_study_translations", force: true do |t|
    t.integer  "about_study_id", null: false
  ...
  add_index "about_study_translations", ["about_study_id"], name: "index_about_study_translations_on_about_study_id", using: :btree
  add_index "about_study_translations", ["locale"], name: "index_about_study_translations_on_locale", using: :btree
  ...
  create_table "mission_translations", force: true do |t|
  ...
  add_index "mission_translations", ["locale"], name: "index_mission_translations_on_locale", using: :btree
  add_index "mission_translations", ["mission_id"], name: "index_mission_translations_on_mission_id", using: :btree
